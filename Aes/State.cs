    ...
    public class State
    {
        ...
        public State SubBytes()
        {
            ...
            for (int r = 0; r < Rows; r++)
            {
                for (int c = 0; c < Columns; c++)
                {
                    s.buf[r, c] = Sbox.SboxTable[buf[r, c]];
                    //Console.Out.WriteLine("state[" + r + "," + c + "]=" + buf[r, c] + " --> " + s.buf[r, c]);
                }
            }
            return (s);
        }
        ...
        public State SubBytesInv()
        {
            ...
            for (int r = 0; r < Rows; r++)
            {
                for (int c = 0; c < Columns; c++)
                {
                    s.buf[r, c] = Sbox.InvertedSboxTable[buf[r, c]];
                }
            }
            return (s);
        }
